            ...
            <footer className='product-info_footer'>
                ...
                <div className='product-info_quantity-container'>
                    ...
                    <div className='counter'>
                        ...
                        <div className='counter_number'>1</div>
                        <div onClick={handlePlus} className='counter_plus'>+</div>
                    </div>
                </div>
                <button onClick={handleAddCart} className='product-info_btn'>Add to Cart<i className=" product-info_icon 
                product_icon fa-solid fa-cart-shopping"></i></button>
            </footer>
        </article>
    )
}
